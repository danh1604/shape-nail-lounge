  ...
  setTimeout(async () => {
    try {
      ...
      const reminderHtml = `
        ...
        <p>This is a friendly reminder for your upcoming appointment at Shape Nail Lounge.</p>
        <p><strong>Date:</strong> ${appointment_date} at ${appointment_time}</p>
        <p>Please arrive 10 minutes early so we can prepare everything for you.</p>
