...
function App() {
  ...
  const bookingServices = [
    ...
    ["04", "Gel-X Full Set"],
    ["05", "Gel-X Fill In"],
    ["06", "Builder Gel Full Set"],
    ["07", "Builder Gel Fill In"],
    ["08", "Manicure"],
    ["09", "Gel Manicure"],
    ["10", "Polish Change - Hands or Toes"],
    ["11", "Gel Polish Change - Hands or Toes"],
    ["12", "Classic Spa Pedicure"],
    ["13", "Deluxe Spa Pedicure"],
    ["14", "Lemongrass & Green Tea Pedicure"],
    ["15", "Collagen Pedicure"],
    ["16", "Kids Polish Change - Hands"],
    ["17", "Kids Gel Polish Change - Hands"],
    ["18", "Kids Classic Pedicure"],
    ["19", "Eyebrows"],
    ["20", "Upper Lip"],
    ["21", "Chin"],
    ["22", "Face Combo"],
